...
public class MainActivity extends AppCompatActivity {
        ...
        try{
            cursor = database.query(TodoContract.FeedEntry.TABLE_NAME,
                    new String[]{TodoContract.FeedEntry._ID,
                            TodoContract.FeedEntry.DATE,
                            TodoContract.FeedEntry.STATE,
                            TodoContract.FeedEntry.CONTENT},
                    null, null, null, null,
            ...
            while (cursor.moveToNext()) {
                ...
                long dateMs = cursor.getLong(cursor.getColumnIndex(TodoContract.FeedEntry.DATE));
                int intState = cursor.getInt(cursor.getColumnIndex(TodoContract.FeedEntry.STATE));
    ...
    private void deleteNote(Note note) {
        ...
        int deleteRows = database.delete(TodoContract.FeedEntry.TABLE_NAME,
                        selection,
                        selectionArgs);
        database.close();
        notesAdapter.refresh(loadNotesFromDatabase());
    ...
    private void updateNode(Note note) {
        ...
        int updateRows = database.update(TodoContract.FeedEntry.TABLE_NAME,
